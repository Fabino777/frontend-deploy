...
import WelcomeSection from '@/components/organisms/navbar/welcome/page';
  ...
  return (
    <div id={id} className='bg-gray-900'>
      <div className="py-10  my-5 ">
        <div className={`${backgroundClassName} mt-10 flex lg:flex-row flex-col items-center justify-center gap-10  hover-effect w-[100%] mx-auto dark:${backgroundClassName}`}>
  ...
  return (
    <main className={classNames(classes.main, "flex flex-col")}>
      ...
      <SectionWrapper
        ...
        backgroundClassName="bg-gray-900 dark:bg-gray-900"
      >
        <div className=' text-black bg-gray-900'>
          <div className='text-right w-full bg-gray-900'>
