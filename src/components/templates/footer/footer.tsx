...
export default function Footer(){
  return (
    <>
      <footer className="relative z-10 mx-auto w-full bg-gray-900 pt-16 dark:bg-gray-900 md:pt-20 lg:pt-24  ">
                ...
                <ul>
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
						<div className="ml-[-30px] flex flex-row"><DiscordIcon /> &nbsp; Dicord</div>
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      <div className="ml-[-30px] flex flex-row"><TwitterIcon /> &nbsp; Twitter</div>
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      <div className="ml-[-30px] flex flex-row"><GitHubIcon /> &nbsp; Github</div>
                    </Link>
                  </li>
                </ul>
              </div>
